    ...
    <Container>
        <Left>
            ...
            <SocialContainer>
                ...
                <SocialIcon color="55ACEE"><Pinterest/></SocialIcon>
                <SocialIcon color="E60033"><LinkedIn/></SocialIcon>
            </SocialContainer>
        </Left>
        <Center>
        ...
        <Right>
            <Title>Contact</Title>
            <ContactItem><Map style={{marginRight:"10px"}}/>contact location</ContactItem>
            <ContactItem><Phone style={{marginRight:"10px"}}/>contact number</ContactItem>
            <ContactItem><Email style={{marginRight:"10px"}}/>contact email</ContactItem>
